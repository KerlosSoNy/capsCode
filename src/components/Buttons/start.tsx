...
import { CodeIcon, CoffeeIcon, HelpingHandIcon, PersonStandingIcon, TimerIcon } from "lucide-react";
            ...
            <Modal>
                <ModalTrigger className="bg-transparent border-[1px] border-white  !rounded-full text-white flex justify-center group/modal-btn">
                    ...
                    <div className="-translate-x-40 group-hover/modal-btn:translate-x-0 flex items-center justify-center absolute inset-0 transition duration-500 text-white z-20">
                        <Image src='/assets/withoutWards.png' width={30} height={30} className='w-[25px] !h-[20px]' alt='logo' />
                    </div>
                </ModalTrigger>
                <ModalBody>
                    <ModalContent>
                        <h4 className="text-lg md:text-2xl text-neutral-600 dark:text-neutral-100 font-bold text-center mb-8">
                            Create your feature now !{" "}
